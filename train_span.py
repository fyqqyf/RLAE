...
Example usage:
  ...
  python train_span.py --algo ppo --mode span --span_length 4 --batch_size 32
  
  # Train MAPPO span model
  python train_span.py --algo mappo --mode span --span_length 4 --num_agents 2
  ...
  python train_span.py --test all
    ...
    # Training parameters
    parser.add_argument(
        "--span_length", type=int, default=4, help="Span length (default 4)"
    )
    parser.add_argument(
