...
def train(
    ...
    policy = EnsembleWeightPolicy(num_models=num_models, encoder_name=encoder_name)
    if torch.cuda.is_available():
        policy = policy.cuda()
    trainer = PPOTrainer(policy=policy, api_url=api_url)
